...
public class SaltBrickStair extends BlockStairs {
	...
	public SaltBrickStair() {
        super(SaltBlocks.SALT_BLOCK.getDefaultState().withProperty(SaltBlock.VARIANT, SaltBlock.EnumType.BRICK));
	...
	public void onEntityWalk(World worldIn, BlockPos pos, Entity entity) {
		this.saltDamage(worldIn, entity);
